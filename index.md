...
ADHDAI uses prompt engineering, constraint inversion, and deliberate misalignment to generate outputs that *look* professional but feel wrong.
...
- Overcommitment to bad ideas  
- Underdocumentation  
- Occasional moments of accidental insight  

## Contributing

Contributions are welcome if they:
- Make the ads worse in interesting ways  
- Preserve the conceptual intent  
- Do not try to "fix" the outputs  

PRs that improve effectiveness may be rejected on principle.

## License / Disclaimer

This project is for satire, research, and artistic exploration.

Any resemblance to real advertising campaigns, living brands, or doomed startups is probably not coincidental.
